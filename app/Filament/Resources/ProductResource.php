            ...
            ->schema([
                Forms\Components\Group::make()->schema([
                    Section::make()->schema([
                        ...
                        TextInput::make('slug')->required()->disabled()->dehydrated()->unique(Product::class, 'slug', ignoreRecord: true),
                    ...
                    Section::make('Pricing and Inventory')->schema([
                        ...
                        TextInput::make('quantity')->numeric()->minValue(0)->maxValue(500)->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                SelectFilter::make('brand')->relationship('brand', 'name') //label('Visibility')->boolean()->trueLabel('Only Visible Products')->falseLabel("Only Hidden Products")->native(false)
            ])
            ->actions([
